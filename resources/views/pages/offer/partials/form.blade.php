                ...
                <div class="flex-1">
                    <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="w-full">
                            <x-form.select.choices-select name="customer_id"
                                                          data-kt-value="{{ isset($offer) ? $offer->customer_id : '' }}"
                    ...
                    <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="w-full flex gap-2.5">
                            <x-form.input.default class="flex-1" placeholder="Teklif tarih..." name="date" type="date" value="{{ date('Y-m-d') }}"/>
                            <x-form.input.default class="flex-1" placeholder="Geçerlilik tarih..." name="validity_date" type="date" value="{{ date('Y-m-d', strtotime('+7 days')) }}"/>
                        </div>
                    </div>
                </div>
                <div class="flex-1">
                    ...
                    <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="w-full">
                            <x-form.select.choices-select name="special_group1_id" value=""
                                                          ...
                                                          data-kt-key="{{ unique_code() }}"
                                                          data-kt-value="{{ isset($offer) ? $offer->special_group1_id : '' }}"
                                                          data-kt-section="{{ \App\Enums\Group\SectionEnum::OFFER->value }}"
                                                          data-kt-type="{{ \App\Enums\Group\TypeEnum::OFFER_SG1->value }}"
                            >
                            </x-form.select.choices-select>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="w-full">
                            <x-form.select.choices-select name="special_group2_id" value=""
                                                          data-kt-group-select="true"
                                                          data-kt-value="{{ isset($offer) ? $offer->special_group2_id : '' }}"
                                                          data-kt-key="{{ unique_code() }}"
                                                          data-kt-section="{{ \App\Enums\Group\SectionEnum::OFFER->value }}"
                                                          data-kt-type="{{ \App\Enums\Group\TypeEnum::OFFER_SG1->value }}"
                            >
                    ...
                    <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="w-full">
                            <x-form.select.choices-select name="special_group3_id" value=""
                                                          data-kt-group-select="true"
                                                          data-kt-value="{{ isset($offer) ? $offer->special_group3_id : '' }}"
                                                          data-kt-key="{{ unique_code() }}"
                                                          data-kt-section="{{ \App\Enums\Group\SectionEnum::OFFER->value }}"
                                                          data-kt-type="{{ \App\Enums\Group\TypeEnum::OFFER_SG1->value }}"
                            >
                    ...
                    <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="w-full">
                            <x-form.select.choices-select name="special_group4_id" value=""
                                                          data-kt-group-select="true"
                                                          data-kt-value="{{ isset($offer) ? $offer->special_group4_id : '' }}"
                                                          data-kt-key="{{ unique_code() }}"
                                                          data-kt-section="{{ \App\Enums\Group\SectionEnum::OFFER->value }}"
                                                          data-kt-type="{{ \App\Enums\Group\TypeEnum::OFFER_SG1->value }}"
                            >
                ...
                <div class="card card-grid min-w-full">
                    ...
                    <div class="card-body">
                        <div>
                            <table id="user_table" class="w-full dataTable table table-auto table-border align-middle text-gray-700 font-medium text-sm">
                                ...
                                <tr>
                                    ...
                                    <th class="min-w-[100px]">İsk.1(%)</th>
                                    <th class="min-w-[100px]">İsk.1(₺)</th>
                                    <th class="min-w-[100px]">İsk.2(%)</th>
                                    <th class="min-w-[100px]">İsk.2(₺)</th>
                                    <th class="min-w-[100px]">İsk.3(%)</th>
                                    <th class="min-w-[100px]">İsk.3(₺)</th>
                                    <th class="min-w-[100px]">İsk.4(%)</th>
                                    <th class="min-w-[100px]">İsk.4(₺)</th>
                                    <th class="min-w-[100px]">İsk.5(%)</th>
                                    <th class="min-w-[100px]">İsk.5(₺)</th>
                                    <th class="min-w-[100px]">K.D.V(%)</th>
                                    <th class="min-w-[175px] text-end">İskonto Top.</th>
                        ...
                        <div class="flex gap-2.5 mx-4 my-2">
                            ...
                            <div class="md:flex-1">
                                <a href="javascript:void(0);" class="btn btn-sm btn-outline btn-info" data-kt-offer-add-product-button="true">
                                    Ekle
                    ...
                    <div class="card-body pt-3.5 pb-3.5">
                        <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <div class="w-full text-end">
                                <span class="font-bold text-gray-900" data-kt-offer-total="service_total">₺0,00</span>
                            </div>
                        </div>
                        <x-separator.default/>
                        <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <div class="w-full text-end">
                                <span class="font-bold text-gray-900" data-kt-offer-total="stock_total">₺0,00</span>
                            </div>
                        </div>
                        <x-separator.default/>
                        <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <div class="w-full text-end">
                                <span class="font-bold text-gray-900" data-kt-offer-total="discount_total">₺0,00</span>
                            </div>
                        </div>
                        <x-separator.default/>
                        <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <div class="w-full text-end">
                                <span class="font-bold text-gray-900" data-kt-offer-total="sub_total">₺0,00</span>
                            </div>
                        </div>
                        <x-separator.default/>
                        <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <div class="w-full text-end">
                                <span class="font-bold text-gray-900" data-kt-offer-total="vat_total">₺0,00</span>
                            </div>
                        </div>
                        <x-separator.default/>
                        <div class="flex-1 flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                            ...
                            <div class="w-full text-end">
                                <span class="font-bold text-gray-900" data-kt-offer-total="total">₺0,00</span>
                            </div>
                        </div>
                    </div>
                </div>
